...
@section('script')
	<script type="text/javascript">
	    ...
	    @if(Route::current()->getParameter('page_number'))
	    	var url = "https://yts.ag/api/v2/list_movies.json?page={{ Route::current()->getParameter('page_number') }}";
	    @else
	    ...
	    $.getJSON(url, function(result){
	        $.each(result.data.movies, function(index, value){
	        	html = html + "<div class='col s12 m3'>"+
		          "<div class='card'>"+
...
@section('content')
	<div class="section no-pad-bot" id="index-banner">
    	<div class="container">
	      	<br><br>
	      	<h1 class="header center grey-text darken-3">Movie List</h1>
